    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProId,ProName,ProDescription,ProPrice,Stock,ProPic")] Product product, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                ...
                string upath = Path.Combine(Server.MapPath("~/Images"), filename);
                file.SaveAs(upath);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProId,ProName,ProDescription,ProPrice,Stock,ProPic")] Product product, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
